...
#    st.markdown(f"[📎 Sample File: S25DL-roster.csv]({default_url})")
    ...
    if all(col in df.columns for col in ['Course', 'Name_ori']):
        ...
        st.markdown("##### 🌱 Step3: Group Settings (Currently 18 students: 3*3G and 4*3G)")
...
with tabs[3]:
    ...
    button_html = """
        ...
        <a href="https://docs.google.com/spreadsheets/d/127bYIkBTMz0BNtERxJ_RKHt37OOAvjwPh7zUBNWQDYg/edit?usp=sharing" target="_blank">
